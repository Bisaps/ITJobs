                  ...
                  <div class="dash-table">
                     <table class="table table-bordered">
                        ...
                        <tbody>
                           ...
                           $sql="SELECT FName,Number,Email,Password,UID FROM jobs";
                           ...
                           if ($result->num_rows > 0) {
                              while ($row = $result->fetch_assoc()) {
                                 ...
                                 echo   '<td><span class="rem-action btn btn-danger" data-record-id="'. $row['UID'] .'">remove</span></td>';   
                                 echo '</tr>';
                           }
                        }
                           ?>
...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['confirmed_id'])) {
    ...
    $sql = "DELETE  FROM jobs WHERE UID = $recordId";
...
?>
    ...
    $('.rem-action').on('click', function() {
        ...
        var confirmation = confirm("Do you really want to remove this user?");
